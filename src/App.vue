...
<template>
  <div
    class="bg-slate-800 h-screen w-full flex md:flex-col lg:flex-row  justify-center items-center gap-4 border border-gray-300 p-4">
    <div class="w-full">
      ...
      <select id="select1" v-model="option1" @change="fetchMakes"
        class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm h-[30px]">
